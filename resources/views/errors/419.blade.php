...
<head>
    ...
    <title>Halaman Kadaluarsa - 419</title>
...
<body class="bg-404 min-h-screen flex items-center">
    <div class="container mx-auto px-4">
        <div class="max-w-md mx-auto text-center">
            ...
            <h1 class="text-5xl font-bold primary-color mb-4">419</h1>
            <h2 class="text-2xl font-semibold text-gray-800 mb-6">Oops! Halaman Ini Kadaluarsa</h2>
            <p class="text-gray-600 mb-8">
                Sepertinya Anda terlalu lama di lautan digital. Mari kita bantu Anda kembali ke daratan.
            </p>
