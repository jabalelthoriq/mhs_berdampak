...
<body class="bg-404 min-h-screen flex items-center">
    <div class="container mx-auto px-4">
        <div class="max-w-md mx-auto text-center">
            ...
            <h1 class="text-5xl font-bold primary-color mb-4">404</h1>
            <h2 class="text-2xl font-semibold text-gray-800 mb-6">Oops! Halaman Tidak Ditemukan</h2>
            <p class="text-gray-600 mb-8">
                Sepertinya Anda tersesat di lautan digital. Mari kita bantu Anda kembali ke daratan.
            </p>
